      ...
      try {
        ...
        if (result.success) {
          ...
          toast({
            ...
            description: "Welcome to ISO Management System!",
          });
          
          // Redirect to ISO dashboard
          setTimeout(() => {
            navigate('/iso');
          }, 1500);
        } else {
      ...
      <div className="flex flex-col items-center justify-center min-h-screen p-5">
        ...
        <div className="login-card-inner">
          <div className="login-header">
            <h1>ISO Management System</h1>
            <p>Sign in to access quality management</p>
          </div>
