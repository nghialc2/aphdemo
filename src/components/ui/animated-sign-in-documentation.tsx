...
const DocumentationLoginPage: React.FC = () => {
      ...
      try {
        ...
        if (result.success) {
          ...
          toast({
            ...
            description: "Welcome to Documentation System!",
          });
      ...
      <div className="flex flex-col items-center justify-center min-h-screen p-5">
        ...
        <div className="login-card-inner">
          <div className="login-header">
            ...
            <p>Sign in to access knowledge & documentation</p>
          </div>
...
export default DocumentationLoginPage;