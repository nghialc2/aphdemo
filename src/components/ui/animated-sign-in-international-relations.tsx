...
const InternationalRelationsLoginPage: React.FC = () => {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Welcome to International Relations Dashboard",
        });
        // Redirect to International Relations dashboard
        setTimeout(() => {
      ...
      <div className="flex flex-col items-center justify-center min-h-screen p-5">
        ...
        <div className="login-card-inner">
          <div className="login-header">
            ...
            <p>Sign in to access global partnerships & collaborations</p>
          </div>
...
export default InternationalRelationsLoginPage;