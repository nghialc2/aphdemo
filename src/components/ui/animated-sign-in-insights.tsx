...
const InsightsLoginPage: React.FC = () => {
  ...
  const { signInWithGoogle, loading } = useInsightsAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // For now, redirect to Google Auth but this could be expanded to support email/password
      await signInWithGoogle();
      toast({
        title: "Redirecting to Google",
        description: "Please complete authentication with your @fsb.edu.vn account",
      });
    } catch (error) {
      toast({
        title: "Login Error",
      ...
      <div className="flex flex-col items-center justify-center min-h-screen p-5">
        ...
        <div className="login-card-inner">
          <div className="login-header">
            <h1>InsightsLM Platform</h1>
            <p>Sign in to access AI-powered insights</p>
          </div>
...
export default InsightsLoginPage;