-- ============================================================================
-- INSIGHTSLM TABLES MIGRATION FOR DOCUMENTATION FEATURE
...
-- Sources policies (using a simpler approach)
...
-- 1. 'sources' - for PDF, text, and audio files
-- 2. 'audio-overviews' - for generated audio content